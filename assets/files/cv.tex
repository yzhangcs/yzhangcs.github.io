...
%\font\fb=''[cmr10]'' %for use with \LaTeX command (XeTeX only)
...
\par{{\large Moonshot AI}\bigskip\par}

\begin{tabular}{@{}p{0.5\textwidth}@{}p{0.5\textwidth}@{}}
      \makebox[1.5em][l]{\faEnvelope}\href{mailto:yzhang.cs@outlook.com}{\texttt{yzhang.cs@outlook.com}}          &
      \makebox[1.5em][l]{\faGithub}\href{https://github.com/yzhangcs}{\texttt{https://github.com/yzhangcs}}         \\
      \makebox[1.5em][l]{\faTwitter}\href{https://twitter.com/yzhang_cs}{\texttt{https://twitter.com/yzhang\_cs}} &
      \makebox[1.5em][l]{\faHome}\href{https://yzhang.site}{\texttt{https://yzhang.site}}
\end{tabular}

\section{Profile}
 {\color{gray}I am a final-year PhD student at Soochow University, advised by Prof. Guohong Fu.
  Prior to this, I received my M. Eng. degree from Soochow University in 2021.

  \emph{My early research focused on structured prediction tasks, specifically dependency parsing and constituency parsing.}}
My research interests have evolved to focus on developing efficient text generation models.
...
I am also a primary maintainer of \href{https://github.com/fla-org/flash-linear-attention}{Flash Linear Attention}, an efficient and extensible library for building efficient model architectures.
...
\section{Projects}
\begin{itemize}[leftmargin=18pt]
      \item \href{https://github.com/fla-org/flash-linear-attention}{\textbf{FLA}} (\textbf{\emph{\textcolor{brickred}{4.7K stars}}}): A Triton-Based Library for Hardware-Efficient Implementations of Linear Attention Mechanism.
...
\section{Experience}
\begin{itemize}[leftmargin=18pt]
      \item 2025 - present. AI researcher at \textbf{Moonshot AI}.
