...
\section{Profile}
I am a full-time researcher at \href{https://www.moonshot.ai/}{Moonshot AI}.
I received my PhD from Soochow University in 2026, where I was advised by Prof. Guohong Fu.
...
\begin{minipage}[c]{4.8em}
      \centering
      \href{https://github.com/fla-org/flash-linear-attention}{\includegraphics[width=4.2em]{fla-logo.png}}
\end{minipage}\hspace{0.8em}%
\begin{minipage}[c]{\dimexpr\textwidth-5.6em\relax}
      \href{https://github.com/fla-org/flash-linear-attention}{\textbf{Flash Linear Attention}}\par
      A library of hardware-efficient kernels, layers, and model components for emerging sequence modeling architectures, spanning linear attention, sparse attention, state-space models, and hybrid LLMs.
\end{minipage}
...
\section{Experience}
\begin{itemize}[leftmargin=18pt]
      \item 2025 - present. Researcher at \textbf{Moonshot AI}.
...
\section{Education}
\begin{itemize}[leftmargin=18pt]
      \item 2021 - 2026. \emph{PhD} from \textbf{Soochow University}, advised by Prof. Guohong Fu.
